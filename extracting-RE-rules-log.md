...
<p align="center">
<div align="center">
  Table.1 F1-Score for manual rule-based approach    <br />
...
<p align="center">
<div align="center">
  Table.2 F1-Score of automatic rule extraction approach for closed-test data   <br />
...
|:----------|--------:|------:|--------:|------:|-----:|
| Consonant Error | 0.4748 | 0.7934 | 0.8108 | 0.8457 | **0.9642** |
| Dialect Error | 0.7973 | 0.8756 | 0.8998 | 0.8933 | **0.9131** |
| Encoding Error | 0.8034 | 0.7772 | 0.8238 | 0.8520 | **0.9005** |
| Phonetic Error | 0.0029 | **0.4469** | 0.3965 | 0.4105 | 0.4436 |
| Phonetic-Typo Error | 0.0329 | 0.9305 | 0.8965 | 0.9119 | **0.9438** |
| Sensitive Error | 0.8443 | 0.8756 | 0.8366 | 0.9385 | **0.9688** |
| Sequence Error | 0.8543 | 0.8583 | 0.8953 | 0.9025 | **0.9403** |
| short-Form Error | 0.4680 | 0.6787 | 0.7052 | 0.7082 | **0.7277** |
| Slang-Word Error | 0.3184 | 0.7969 | 0.8330 | 0.8736 | **0.9314**|
| Stack-Word Error | 0.9423 | 0.8912 | 0.9176 | 0.9511 | **0.9792** |
| Typo Error | 0.0052 | 0.7070 | 0.6069 | 0.6532 | **0.7114** |
</div>
 </p>
<br />
<p align="center">
<div align="center">
  Table.3 F1-Score of automatic rule extraction approach for open test data   <br />
   Here, Error-Correction pattern is containing for all pattern group. <br />
...
| Type of Error   | Error-Correction | Prefix-Error-Correction-Suffix |  Prefix-Error-Correction | Error-Correction-Suffix | All |
|:----------|--------:|------:|--------:|------:|-----:|
| Consonant Error | 0.4748 | 0.7934 | 0.8108 | **0.8457** | 0.8169 |
| Dialect Error | 0.7419 | **0.7742** | **0.7742** | **0.7742** | **0.7742** |
| Encoding Error | 0.5143 | 0.6098 | 0.6098 | **0.6204** | 0.6098 |
| Phonetic Error | 0.002 | **0.4067** | 0.3720 | 0.3782 | 0.3979 |
| Phonetic-Typo Error | 0.0256 | **0.8819** | 0.8381 | 0.8588 | 0.8665 |
| Sensitive Error | 0.6292 | 0.5455 | 0.5283 | **0.6800** | **0.6800** |
| Sequence Error | **0.7294** | 0.6933 | 0.7068 | 0.7131 | 0.7003 |
| short-Form Error | 0.3670 | 0.5839 | **0.6043** | 0.5839 | 0.5839 |
| Slang-Word Error | 0.2610 | 0.6217 | 0.6514 | **0.6937** | 0.6603 |
| Stack-Word Error | **0.8454** | 0.6948 | 0.7158 | 0.7703 | 0.7456 |
| Typo Error | 0.0055 | **0.5702** | 0.5048 | 0.5353 | 0.5580 |
</div>
 </p>
   
Table.1 ရလဒ်တွေက test data (i.e. test input file for spelling checking) ကိုလည်း F1-score တိုင်းတာကြည့်ဖြစ်ခဲ့ပါတယ်။ ပြီးတော့ အိဖြူဖြူမွန်က manual ဆွဲထုတ်ထားတဲ့ rule တွေကို သုံးပြီး spelling correction လုပ်ပြီး ရလာတဲ့ ရလဒ်တွေနဲ့ နှိုင်းယှဉ်ကြည့်ထားတာပါ။  
...
Table. 3 ရလဒ်တွေကနေ နားလည်တာကတော့ open test မှာတော့ best-score ပေးတာက pattern မျိုးစုံကနေ ထွက်လာတာကို တွေ့ရတယ်။  
   
Pattern တွေကို မြင်အောင် ပြရရင်တော့ အောက်ပါအတိုင်းပါ။ head နဲ့ ခေါက်ကြည့်လိုက်၊ tail နဲ့ ခေါက်ကြည့်လိုက် လုပ်ကြည့်ပြီး ဥပမာအနေနဲ့ မြင်သာတဲ့ pattern ပိုစုံတဲ့ output ကို ရွေးပြထားပါတယ်။     
   
### Error-Correction Pattern
   
```
(base) ye@:/media/ye/project2/exp/errant/my-data/4github/ec$ head -3 *.uniq
==> con.rule.uniq <==
[-၀ ၀ ရှှု-]	{+ဝ ဝ ရှူ+}	ec
[-၀ ၀-]	{+ဝ ဝ+}	ec
[-၀ံ့ ၀ံ့-]	{+ဝံ့ ဝံ့+}	ec
...
[-d a-]	{+ဒ+}	ec
[-D a-]	{+ဒ+}	ec
[-M a T a r P a w-]	{+မ သာ ပေါ်+}	ec

==> seq.rule.uniq <==
[-၀တ်-]	{+ဝတ်+}	ec
[-၀န်-]	{+ဝန်+}	ec
[-၀ေ လျှာ့-]	{+၀ လျှော့+}	ec
...
### Prefix-Error-Correction-Suffix
   
```
(base) ye@:/media/ye/project2/exp/errant/my-data/4github/pecs$ tail -n 3 *.uniq
==> con.rule.uniq <==
ဧ 	[-ယ ဥ်-]	{+ယင်+}	 ကျူး	pecs
[-ေ ၇-]	{+ရေ+}	ec
[-ေြ သာ် ယောက်-]	{+ဪ ယောက်ျား+}	ec
...
```
(base) ye@:/media/ye/project2/exp/errant/my-data/4github/pec$ tail -n 3 *.uniq
==> con.rule.uniq <==
ဧ 	[-ရာေ ၇-]	{+ရာ ရေ+}	pec
[-ေ ၇-]	{+ရေ+}	ec
[-ေြ သာ် ယောက်-]	{+ဪ ယောက်ျား+}	ec
...
==> encode.rule.uniq <==
ဦး 	[-ခြ သေ့ၤ-]	{+ခြင်္သေ့+}	pec
ဦး 	[-ရြဲ မတ်-]	{+ရဲ မြတ်+}	pec
[-ေ ကာ င့်-]	{+ကြောင့်+}	ec
...
==> sensitive.rule.uniq <==
ဦး 	[-T a y S o n e-]	{+ဆုံး+}	pec
ဦး 	[-T a y S o n e-]	{+သေ ဆုံး+}	pec
ဦး 	[-T a y-]	{+သေ+}	pec
...
==> short.rule.uniq <==
ဟို 	[-မှာိး-]	{+မှာ လီး+}	pec
အ 	[-၆-]	{+ခြောက်+}	pec
အောင် 	[-ဘို-]	{+ဘယ် လို+}	pec
...
[-ေ မာတ္တာ ပို-]	{+မေတ္တာ ပို့+}	ec
[-ေ လ-]	{+ကွာ လေ+}	ec
(base) ye@:/media/ye/project2/exp/errant/my-data/4github/pec$                     
```
   
### Error-Correction-Suffix

```
(base) ye@:/media/ye/project2/exp/errant/my-data/4github/ecs$ tail -n 3 *.uniq
==> con.rule.uniq <==
[-ေ ၇-]	{+ရေ+}	 ကန်	ecs
[-ေ စျး-]	{+ဈေး+}	 က	ecs
[-ေြ သာ် ယောက်-]	{+ဪ ယောက်ျား+}	ec
...
==> stack.rule.uniq <==
[-ဥက် က ဌ-]	{+ဥက္ကဋ္ဌ+}	 ကို	ecs
[-ဥက် က ဌ-]	{+ဥက္ကဋ္ဌ+}	 ရေ	ecs
[-ဥစ် စာ-]	{+ဥစ္စာ+}	 ပြည့်	ecs

==> typo.rule.uniq <==
[-။်-]	{+။+}	 ဒီ	ecs
[-၍်-]	{+၍+}	 ဖတ်	ecs
[-၍်-]	{+၍+}	 သူ့	ecs
(base) ye@:/media/ye/project2/exp/errant/my-data/4github/ecs$
```
                        
### All

```
(base) ye@:/media/ye/project2/exp/errant/my-data/4github$ head  *.uniq
==> con.rule.uniq <==
၀ 	[-၀န်း-]	{+ဝန်း+}	 ကျင်	pecs
[-၀က်-]	{+ဝက်+}	ec
[-၀က်-]	{+ဝက်+}	 ပိုး	ecs
