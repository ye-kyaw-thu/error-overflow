...
အဲဒါကြောင့် ဘယ် approach က သာတယ်ဆိုတာကို prove လုပ်ဖို့ ဆိုရင် လုပ်လို့ ရတဲ့ နည်းလမ်းတစ်ခုက statistical test လုပ်တာ တနည်းအားဖြင့် paired bootstrap resampling လုပ်ပြီး machine translation evaluation လုပ်တာပါ (Philipp Koehn, 2004)။ 
...
[compare-mt-demo/](https://github.com/ye-kyaw-thu/error-overflow/tree/master/compare-mt-demo) ဖိုလ်ဒါအောက်မှာ html report နှစ်ခုရဲ့ ဖိုလ်ဒါတွေကို upload လုပ်ပေးထားပါတယ်။ ပထမ ဖိုလ်ဒါက ဘိတ်ကနေ ရခိုင်ဘာသာကို SMT လုပ်တာကို pivot language အနေနဲ့ ဗမာစာကို ထားထားပြီး လုပ်ခဲ့တဲ့ Triangulation-Pivot experiment ပါ။ ဒီနေရာမှာ BLEU score နဲ့ ကြည့်မယ်ဆိုရင် baseline (i.e. normal PBSMT translation) ထက် Triangulation-Pivot experiment ရဲ့ ရလဒ်တွေက statistically significance (p <= 0.05) ဖြစ်တယ်ဆိုတာကို လေ့လာနိုင်ပါတယ်။   
...
(Click the above link to see the full HTML report) 
...
2. [Bootstrap Resampling for Beik-Burmese-Rakhine (Transfer vs Triangulation)](https://htmlpreview.github.io/?https://github.com/ye-kyaw-thu/error-overflow/blob/master/compare-mt-demo/bk-my-rk-transfer-vs-triangulation/index.html)  
(Click the above link to see the full HTML report) 
...
"\\"နောက်မှာ ကပ်လျက် Enter ခေါက်မှ run လို့ရပါလိမ့်မယ်။ "\\" နောက်မှာ space တစ်ခု...ဘာညာ... ပါသွားရင် shell script ကို run တဲ့အခါမှာ error ပေးပါလိမ့်မယ်။  
