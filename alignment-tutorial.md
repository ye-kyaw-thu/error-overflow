...
When I run on my local laptop with the whole corpus, it tooks around 20 minutes. The reason might be I am also running many jupyter notebooks on my local notebook computer. And thus, I installed GIZA++ toolkit on CADT server and run demo on server.  
