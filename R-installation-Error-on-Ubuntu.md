...
I wanna draw error-bar graph with R. And thus, install R on my Ubuntu notebook and got error relating to "packages have unmet dependencies". This is the log file for clearing that error. You can skip directly to the Solution<a id='1.1'></a>.
