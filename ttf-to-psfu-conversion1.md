...
ပြောင်းပြီးသား text ဖိုင်ကို လေ့လာခဲ့ ...  

```
(base) ye@ykt-pro:/media/ye/project1/cadt/student/internship/demo/code/console-font-dev/ttf-console-fonts-20170403_abc5771$ head ./notosansmyanmar-bold-x.psfu.txt 
@psf2
Width: 21
Height: 56
Pixel: #
...
ဖတ်လို့ မရတာတွေ၊ မြန်မာစာလုံးအနေနဲ့ မတွေ့ရတာတွေ အများကြီးပဲ ...  
