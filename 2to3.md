...
(2to3 ပရိုဂရမ်ကို "-w" option နဲ့ run ရင် Python2 ပရိုဂရမ်ကို Python3 နဲ့ run လို့ရဖို့အတွက် ပြင်ရမဲ့ လိုင်းတွေကို ဝင်ပြင်ပေးပါလိမ့်မယ်။ ပြီးတော့ နဂို Python2 ပရိုဂရမ်ကိုလည်း .bak extension နဲ့ backup ကူးပေးထားပါလိမ့်မယ် )"  
...
If you check the ./python2code.py with cat command:  
